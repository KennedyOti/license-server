...
@section('title', 'Create Product - License Server')
...
<form method="POST" action="{{ route('portal.products.store') }}">
    @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea name="metadata" id="metadata" class="form-control" rows="4" placeholder='{"version": "1.0", "description": "Product description"}'>{{ old('metadata') }}</textarea>
