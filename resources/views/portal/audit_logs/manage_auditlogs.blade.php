...
@section('title', 'Manage Audit Logs - License Server')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-3">
                <form method="GET" action="{{ route('portal.audit_logs.manage') }}">
                    ...
                    <select name="entity_type" id="entity_type" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="company" {{ request('entity_type') === 'company' ? 'selected' : '' }}>Company</option>
                    </select>
                </form>
            </div>
            <div class="col-md-3">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $log->company ? $log->company->name : 'System' }}</td>
